...
public final class CreateCommentTests extends CommentTestsBase {
    @Test
    @TestSecurity(user = "user_0")
    public void createCommentOnOwnPost() {
    ...
    @Test
    @TestSecurity(user = "user_0")
    public void createCommentAnonymouslyOnOwnPost() {
        final var commentCount = Comment.count("post", post);
    ...
    @Test
    @TestSecurity(user = "user_0")
    public void createCommentOnOwnDraft() {
        final var input = new CommentCreation("Text", false);
    ...
    public void createCommentOnOtherPost() {
        final var commentCount = Comment.count("post", post);
        final var input = new CommentCreation("Text", false);
        final var response = given().contentType(ContentType.JSON)
                .body(input)
    ...
    @Test
    @TestSecurity(user = "user_1")
    public void createCommentAnonymouslyOnOtherPost() {
        final var commentCount = Comment.count("post", post);
        final var input = new CommentCreation("Text", true);
        given().contentType(ContentType.JSON)
                .body(input)
    ...
    @Test
    @TestSecurity(user = "user_1")
    public void createCommentOnOtherPostWhenBlocked() {
    ...
    @Test
    @TestSecurity(user = "user_1")
    public void createCommentOnOtherAnonymousPostWhenBlocked() {
    ...
    @Test
    @TestSecurity(user = "user_1")
    public void createCommentOnOtherDraft() {
        final var input = new CommentCreation("Text", false);
        given().contentType(ContentType.JSON)
                .body(input)
                .pathParam("id", draft.id)
    ...
    @Test
    @TestSecurity(user = "user_1")
    public void createCommentOnNonExistentPost() {
    ...
    @Test
    @TestSecurity(user = "user_1")
    public void createCommentWithEmptyInput() {
        final var commentCount = Comment.count("post", post);
        given().contentType(ContentType.JSON)
                .pathParam("id", post.id)
                .post()
    ...
    @Test
    public void createCommentWhileUnauthenticated() {
        final var commentCount = Comment.count("post", post);
        final var input = new CommentCreation("Text", false);
        given().contentType(ContentType.JSON)
                .body(input)
